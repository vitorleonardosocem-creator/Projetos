...
def obter_colaboradores_idonics():
    ...
    apenas com planos de trabalho elegíveis para o jogo (PLANOS_JOGO).
    ...
    Filtros aplicados:
      ...
      - Plano de trabalho com Codigo em PLANOS_JOGO
        → exclui automaticamente: ex-funcionários, clientes,
          fornecedores, contas de sistema, placeholders e
          colaboradores de outras empresas/planos
    """
