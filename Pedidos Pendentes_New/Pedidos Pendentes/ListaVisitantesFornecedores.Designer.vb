...
Partial Class ListaVisitantesFornecedores
    ...
    Private Sub InitializeComponent()
        ...
        dgvVisitantes.Size = New Size(1550, 673)
        dgvVisitantes.TabIndex = 3
        ' 
        ' ListaVisitantesFornecedores
        ' 
        AutoScaleDimensions = New SizeF(7F, 15F)
        AutoScaleMode = AutoScaleMode.Font
        ClientSize = New Size(1550, 697)
        Controls.Add(dgvVisitantes)
        Controls.Add(MenuStrip1)
        Name = "ListaVisitantesFornecedores"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Lista Visitantes Fornecedores"
